                    ...
                    <div class="form-group">
                        ...
                        <div class="col">
                            <input type="hidden" class="form-control" name="idpaciente" id="idpaciente" v-model="formp.idpaciente">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="dpi" id="dpi" v-on:change="buscar()">
                                </div>
                            </div>
                            <div class="col">
...
export default {
  ...
  methods:{
      buscar(){
          ...
          axios.get("http://localhost/Apiproyect/pacientes?dpi="+ dpi + "&idusuario="+ iduser)
          .then( data =>{
              console.log(data);
      ...
      guardar(){
          this.form.idusuario = localStorage.usuario;
          this.form.token = localStorage.token;
          this.form.idpaciente = document.getElementById("idpaciente").value;
          axios.post("http://localhost/Apiproyect/citas", this.form)
          .then( data => {
            console.log(data);
                    this.makeToast("Listo","Cita Creada","success");
                    this.$router.push("/citas/all-dating");
                }).catch( e =>{
                    console.log(e);
                     this.makeToast("Error","Error al guardar la Cita ","error", "danger");
                })
